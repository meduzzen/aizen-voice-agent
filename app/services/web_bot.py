...
from app.core.config.init_messages import INIT_MESSAGES, FOLLOW_UP_QUESTIONS_VARIATIONS
...
class WebBotService(BaseBotService, LogMixin):
    ...
    async def initialize_config(self) -> None:
        ...
        session_config = SessionConfig(
            instructions=Prompts.SYSTEM_PROMPT.format(chosen_message=self.chosen_message, chosen_question=self.chosen_question,conversational_states=CONVERSATIONAL_STATES_WEBSALES_BOT, scenario=""),
