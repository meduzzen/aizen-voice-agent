    ...
    states=[
        ...
        ConversationalState(
            ...
            instructions=[
                ...
                "  4. Immediately after receiving free slots, present them in a friendly way (e.g., 'We have openings at 10:00, 11:30, and 15:00. Which one works best for you?').",
                "  5. Ask the user to select one of the available times.",
                "If they say NO:",
        ...
        ConversationalState(
            ...
            instructions=[
                ...
                "Convert the selected time to ISO8601 format (if not already in that format).",
