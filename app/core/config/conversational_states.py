    ...
    states=[
        ...
        ConversationalState(
            ...
            instructions=[
                ...
                "  - Politely confirm it by saying: 'I see your company is [company name]. So, I'll record all your data in our database, please give me a minute.'",
                "  - Then immediately and ALWAYS call `create_contact` tool",
            ...
            examples=[
                "I see your company is Bright Homes. Please give me a minute to make a record in our database.",
        ...
        ConversationalState(
            ...
            instructions=[
                ...
                "  - Listen carefully to the user's answer to extract both company name and a brief description of what the company does.",
                ...
                "",
                "STEP 3: Once you receive company name and description from user:",
                "  1. Say: 'Perfect! Thank you for sharing that. Let me extract this information. Now, would you like to schedule an appointment?'",
                "  3. After immediately and ALWAYS call `create_contact` tool",
                "  4. Immediately transition to state 6_get_available_slots",
            ],
            examples=[
                "Could you please share your company name and briefly describe what your company does?",
        ...
        ConversationalState(
            ...
            instructions=[
                ...
                "  4. CALL THE TOOL `get_free_appointment_slots` with the user's timezone. The tool will automatically:",
                "     - Search for available slots",
                "     - Convert all UTC slots to the user's local timezone",
                "     - Return ready-to-display slots",
                "  5. Immediately after receiving converted slots, present them in a friendly way (e.g., 'We have openings at 10:00, 11:30, and 15:00. Which one works best for you?').",
        ...
        ConversationalState(
            ...
            instructions=[
                ...
                "CALL THE TOOL `create_appointment` with:",
                "  - startTime: the selected time WITH timezone offset (e.g., '2025-11-03T11:30:00-04:00' for Toronto)",
                ...
                "  1. Confirm the booking with all details (date and time in user's timezone).",
                "  2. Thank the user.",
