    ...
    states=[
        ...
        ConversationalState(
            ...
            instructions=[
                ...
                "  - Say: 'Perfect! Let me extract and confirm all your information.'",
                "  - Call `get_contact_info` tool to extract structured contact information (firstName, lastName, phone, companyName) from the entire call transcript",
                "  - Then immediately and ALWAYS call `create_contact` tool ONLY with the EXACT data received from `get_contact_info` - do NOT modify it",
        ...
        ConversationalState(
            ...
            instructions=[
                ...
                "  2. ALWAYS call `get_contact_info` tool to extract structured contact information (firstName, lastName, phone, companyName) from the entire call transcript",
                "  3. After extraction, immediately and ALWAYS call `create_contact` tool ONLY with the EXACT data received from `get_contact_info` - do NOT modify or change any values",
